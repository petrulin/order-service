package com.otus.orderservice.client;

import com.otus.orderservice.config.OpenFeignConfiguration;
import com.otus.orderservice.domain.request.auth.CreateUserRequest;
import com.otus.orderservice.domain.response.auth.CreateUserResponse;
